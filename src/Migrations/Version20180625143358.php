 ...
 */
final class Version20180625143358 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, user_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', micro_post_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', liked_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', seen TINYINT(1) NOT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_BF5476CAA76ED395 (user_id), INDEX IDX_BF5476CA11E37CEA (micro_post_id), INDEX IDX_BF5476CAB4622EC2 (liked_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
